...
#include "../../src/traffic_analyzer.hpp"
...
int main(int argc, char *argv[])
{
    ...
    g_object_set(G_OBJECT(pgie), "config-file-path", "config_infer_primary.txt", NULL);
    g_object_set(G_OBJECT(tracker), "ll-lib-file", "/opt/nvidia/deepstream/deepstream/lib/libnvds_nvdcf.so", "ll-config-file", "tracker_config.txt", "tracker-width", 640, "tracker-height", 384, NULL);
