...
RTSP_LATENCY="${RTSP_LATENCY:-150}" # Jitter buffer size (ms) để dọn video xước
...
# Phục hồi về 2 (quét AI mỗi 3 frame) để giữ video mượt ở mức 30 FPS.
INFER_INTERVAL="${INFER_INTERVAL:-2}"

# --- Video Quality ---
STREAMMUX_WIDTH="${STREAMMUX_WIDTH:-640}"
STREAMMUX_HEIGHT="${STREAMMUX_HEIGHT:-640}"
...
enable=1
# Line rules for Street 1
line-crossing-Entry_1=${LC_DX1};${LC_DY1};${LC_DX2};${LC_DY2};${LC_X1};${LC_Y1};${LC_X2};${LC_Y2}
line-crossing-Exit_1=${LC_DX2};${LC_DY2};${LC_DX1};${LC_DY1};${LC_X1};${LC_Y1};${LC_X2};${LC_Y2}
# Line rules for Street 2
line-crossing-Entry_2=${LC2_DX1};${LC2_DY1};${LC2_DX2};${LC2_DY2};${LC2_X1};${LC2_Y1};${LC2_X2};${LC2_Y2}
line-crossing-Exit_2=${LC2_DX2};${LC2_DY2};${LC2_DX1};${LC2_DY1};${LC2_X1};${LC2_Y1};${LC2_X2};${LC2_Y2}
class-id=-1
extended=0
mode=loose
EOF
...
enable-past-frame=1  # Cực kỳ quan trọng để bắt xe phóng nhanh qua Line
...
type=4
codec=1
profile=4         # Mã hoá H264 High Profile (Nét đỉnh cao)
iframeinterval=30 # Gửi 1 Frame mốc mỗi giây để xem chống giật
sync=0
qos=0             # Tắt chế độ tự ý rớt frame của GStreamer
