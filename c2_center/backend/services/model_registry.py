"""
C2 Center Backend — Dynamic Model Registry

Scans the models/ directory at startup to discover available YOLO models.
Models are lazy-loaded into GPU memory on first use and cached.
"""
