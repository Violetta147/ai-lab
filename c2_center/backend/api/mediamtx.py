...
from services.mediamtx import deploy_config
...
async def deploy_mediamtx():
    """Generate and write mediamtx.yml using current camera database.

    This endpoint intentionally performs a simple file write. Reload
    or restart the MediaMTX process externally if required by your
    MediaMTX deployment.
    """
