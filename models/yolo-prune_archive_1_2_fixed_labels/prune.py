...
def run(args):
    ...
    if args.data:
        ...
        config['epochs'] = 200
        config['patience'] = 25  # Giảm xuống 25 để tăng tốc độ lặp
        config['batch'] =   128  # Tự động tối đa hóa batch size cho A100
        config['cache'] = True  # Lưu dataset vào RAM để tăng tốc độ nạp dữ liệu
